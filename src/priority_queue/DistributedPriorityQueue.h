...
#ifndef SRC_PRIORITY_QUEUE_DISTRIBUTEDPRIORITYQUEUE_H_
#define SRC_PRIORITY_QUEUE_DISTRIBUTEDPRIORITYQUEUE_H_
...
#endif  // SRC_PRIORITY_QUEUE_DISTRIBUTEDPRIORITYQUEUE_H_
